...
Project Kickstart 2020 is a programme aimed at teaching children basic programming skills in Scratch, a blocked based visual programming language that is fun and simple to use. Due to the current COVID-19 situation, the programme has been shortened to three online lessons held on Zoom, each being about an hour long.
...
All Lesson Materials can be found [here](https://www.google.com/).